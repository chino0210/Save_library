# Generated by Django 5.0.4 on 2024-05-23 14:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entry_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tagsDetails', to='entrys_save.entrymodel')),
                ('tag_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='entrys_save.tagsmodel')),
            ],
            options={
